"""
Reference: https://github.com/frangipane/reinforcement-learning/blob/master/02-dynamic-programming/discrete_limit_env.py
...
class StudentEnv(DiscreteLimitActionsEnv):
    ...
    def __init__(self):
        ...
        super().__init__(nS, vA, P, initial_state_distribution)
